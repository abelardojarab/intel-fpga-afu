...
TOP_LEVEL_NAME="read_dc_fifo.read_dc_fifo"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/fifo_170/
mkdir -p ./libraries/read_dc_fifo/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_170/sim/read_dc_fifo_fifo_170_4wijrha.v" -work fifo_170     -cdslib ./cds_libs/fifo_170.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/read_dc_fifo.v"                                  -work read_dc_fifo                                    
fi
