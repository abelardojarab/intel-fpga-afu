...
# Tue Mar 21 17:34:48 PDT 2017
# DO NOT MODIFY


# 
# avst_to_avmm "avst_to_avmm" v1.0
#  2017.03.21.17:34:48
# 
# 
...
set_module_property NAME avst_to_avmm
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME avst_to_avmm
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL avst_to_avmm
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file avst_to_avmm.sv SYSTEM_VERILOG PATH avst_to_avmm.sv TOP_LEVEL_FILE
...
add_interface_port avalon_streaming_sink in_data data Input "((((AVMM_ADDR_WIDTH + AVMM_DATA_WIDTH) + 1) - 1)) - (0) + 1"
