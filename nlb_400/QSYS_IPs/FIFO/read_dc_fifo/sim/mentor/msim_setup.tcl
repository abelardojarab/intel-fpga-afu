...
# ----------------------------------------
# If read_dc_fifo.read_dc_fifo is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.0 290 linux 2017.08.01.14:36:10
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "read_dc_fifo.read_dc_fifo"
}
...
ensure_lib              ./libraries/read_dc_fifo/
vmap       read_dc_fifo ./libraries/read_dc_fifo/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_170/sim/read_dc_fifo_fifo_170_4wijrha.v" -work fifo_170    
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/read_dc_fifo.v"                                  -work read_dc_fifo
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L fifo_170 -L read_dc_fifo -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L fifo_170 -L read_dc_fifo -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
