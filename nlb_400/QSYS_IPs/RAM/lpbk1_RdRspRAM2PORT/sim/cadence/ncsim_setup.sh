...
mkdir -p ./libraries/ram_2port_170/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_170/sim/lpbk1_RdRspRAM2PORT_ram_2port_170_7imzrgq.v" -work ram_2port_170       -cdslib ./cds_libs/ram_2port_170.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/lpbk1_RdRspRAM2PORT.v"                                            -work lpbk1_RdRspRAM2PORT                                         
fi
