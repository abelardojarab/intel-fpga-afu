...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_151/sim/lpbk1_RdRspRAM2PORT_ram_2port_151_davj2sq.v" -work ram_2port_151 -cdslib ./cds_libs/ram_2port_151.cds.lib
