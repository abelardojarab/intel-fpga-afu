...
# # End of template
# ----------------------------------------
# If req_C1TxRAM2PORT is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "req_C1TxRAM2PORT"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_151/sim/req_C1TxRAM2PORT_ram_2port_151_t3axzby.v" -work ram_2port_151
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/req_C1TxRAM2PORT.v"                                                               
}
