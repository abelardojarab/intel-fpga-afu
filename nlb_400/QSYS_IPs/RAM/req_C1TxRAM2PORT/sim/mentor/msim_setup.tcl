...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_160/sim/req_C1TxRAM2PORT_ram_2port_160_nfprwsy.v" -work ram_2port_160
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/req_C1TxRAM2PORT.v"                                                               
}
