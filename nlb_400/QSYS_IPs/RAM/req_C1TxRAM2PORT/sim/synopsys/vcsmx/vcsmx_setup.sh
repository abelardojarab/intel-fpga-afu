...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_170/sim/req_C1TxRAM2PORT_ram_2port_170_hecum7i.v" -work ram_2port_170   
