...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_151/sim/req_C1TxRAM2PORT_ram_2port_151_t3axzby.v" -work ram_2port_151
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/req_C1TxRAM2PORT.v"                                                               
fi
