...
module alt_aeuex_ptp_captr_100 #
  (
   parameter WORDS = 8,
   parameter WIDTH = 64,
...
//	ts_in_pkt_d2 <= l8_rx_data_d1[255:160];
	ts_in_pkt_d2 <= {l8_rx_data_d1[255:176],l8_rx_data_d1[175:160]};
     end
   ...
   alt_a10m20k_group cpm
     (
      ...
      .wena(wr_mem_reg),
      .waddr(wraddr_reg),
      .wdata({l8_rx_data_d2,rx_tod_d2,ts_in_pkt_d2}),
      .rclk(clk),
      .raddr(raddr),
...
endmodule // alt_aeuex_ptp_captr_100
