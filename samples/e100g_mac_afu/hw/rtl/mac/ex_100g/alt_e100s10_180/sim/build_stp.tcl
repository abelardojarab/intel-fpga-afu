...
proc main { args } {
  ...
  switch -exact -- $opts(mode) {
    "build" {
      ...
      # names
      set name_replacement_dict [get_name_replacement_dict -dom $dom]
      ...
      dict for { placeholder ip_core_name } $name_replacement_dict {
...
ui::assemble
ui::init_data
ui::add_core_mapping_widget -ip_core_name alt_e100s10 -hier_replacement 0101010101 -candidate_instances { top|fiddle top|biz top|bar|fiddle }
