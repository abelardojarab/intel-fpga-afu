...
module alt_e100s10_pcs_ber_cnt_ns
 #(
  ...
  (
   ...
   //********************************************************************
   // Check Sync Header: Invalid header: rx_blocks[65:64] = 2'h00 -> xnor
   //********************************************************************
...
alt_e100s10_compressor_4to3 c43(.clk(clk), .din(sh_err[NUM_BLOCKS-1:0]), .sum(cmp_w));  
...
endmodule // alt_e100s10_pcs_ber_cnt_ns
