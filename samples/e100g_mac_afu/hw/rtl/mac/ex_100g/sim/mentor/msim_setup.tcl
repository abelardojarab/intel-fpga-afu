...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ex_100g.ex_100g"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/tools/acdstest-rtl/18.0.1/261/linux64/quartus/"
}
...
append ELAB_OPTIONS [subst [ex_100g::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [ex_100g::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
set design_libraries [dict merge $design_libraries [ex_100g::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [ex_100g::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [ex_100g::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
