	component address_decode_mm_to_phy is
		generic (
		...
		port (
			...
			uav_address       : in  std_logic_vector(12 downto 0) := (others => 'X'); -- address
	...
	end component address_decode_mm_to_phy;

	u0 : component address_decode_mm_to_phy
		generic map (
