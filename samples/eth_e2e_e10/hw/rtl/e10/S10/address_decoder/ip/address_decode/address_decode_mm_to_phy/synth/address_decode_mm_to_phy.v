...
module address_decode_mm_to_phy #(
	...
	address_decode_mm_to_phy_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.uav_address            (uav_address),       //   input,  width = 13, avalon_universal_slave_0.address
		...
		.av_address             (av_address),        //  output,  width = 11,      avalon_anti_slave_0.address
