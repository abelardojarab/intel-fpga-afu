	address_decode_rx_sc_fifo #(
		...
		.uav_address       (_connected_to_uav_address_),       //   input,   width = 5, avalon_universal_slave_0.address
		...
		.av_address        (_connected_to_av_address_),        //  output,   width = 3,      avalon_anti_slave_0.address
