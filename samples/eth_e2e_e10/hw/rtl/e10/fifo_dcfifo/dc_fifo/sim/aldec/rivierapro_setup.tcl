...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/dc_fifo/dc_fifo_0/altera_avalon_dc_fifo_170/sim/altera_avalon_dc_fifo.v"             -work altera_avalon_dc_fifo_170
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/dc_fifo/dc_fifo_0/altera_avalon_dc_fifo_170/sim/altera_dcfifo_synchronizer_bundle.v" -work altera_avalon_dc_fifo_170
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/dc_fifo/dc_fifo_0/altera_avalon_dc_fifo_170/sim/altera_std_synchronizer_nocut.v"     -work altera_avalon_dc_fifo_170
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/dc_fifo/dc_fifo_0/sim/dc_fifo_0.v"                                                   -work dc_fifo_0                
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dc_fifo.v"                                                                                    -work dc_fifo                  
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L altera_avalon_dc_fifo_170 -L dc_fifo_0 -L dc_fifo -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L altera_avalon_dc_fifo_170 -L dc_fifo_0 -L dc_fifo -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
