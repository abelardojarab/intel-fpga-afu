...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/../../ip/dc_fifo/dc_fifo_0/altera_avalon_dc_fifo_170/sim/altera_avalon_dc_fifo.v \
  $QSYS_SIMDIR/../../ip/dc_fifo/dc_fifo_0/altera_avalon_dc_fifo_170/sim/altera_dcfifo_synchronizer_bundle.v \
  $QSYS_SIMDIR/../../ip/dc_fifo/dc_fifo_0/altera_avalon_dc_fifo_170/sim/altera_std_synchronizer_nocut.v \
  $QSYS_SIMDIR/../../ip/dc_fifo/dc_fifo_0/sim/dc_fifo_0.v \
  $QSYS_SIMDIR/dc_fifo.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
