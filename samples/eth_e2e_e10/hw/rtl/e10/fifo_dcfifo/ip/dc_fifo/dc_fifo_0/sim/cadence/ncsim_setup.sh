...
TOP_LEVEL_NAME="dc_fifo_0.dc_fifo_0"
QSYS_SIMDIR="./../"
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_avalon_dc_fifo_170/sim/altera_avalon_dc_fifo.v"             -work altera_avalon_dc_fifo_170 -cdslib ./cds_libs/altera_avalon_dc_fifo_170.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_avalon_dc_fifo_170/sim/altera_dcfifo_synchronizer_bundle.v" -work altera_avalon_dc_fifo_170 -cdslib ./cds_libs/altera_avalon_dc_fifo_170.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_avalon_dc_fifo_170/sim/altera_std_synchronizer_nocut.v"     -work altera_avalon_dc_fifo_170 -cdslib ./cds_libs/altera_avalon_dc_fifo_170.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dc_fifo_0.v"                                                          -work dc_fifo_0                                                                     
fi
