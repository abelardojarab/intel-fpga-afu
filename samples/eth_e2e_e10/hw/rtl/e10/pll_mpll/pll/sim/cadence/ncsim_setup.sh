...
mkdir -p ./libraries/altera_iopll_170/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_iopll_170/sim/pll_altera_iopll_170_yi6tfeq.vo" -work altera_iopll_170 -cdslib ./cds_libs/altera_iopll_170.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll.v"                                                   -work pll                                                         
fi
