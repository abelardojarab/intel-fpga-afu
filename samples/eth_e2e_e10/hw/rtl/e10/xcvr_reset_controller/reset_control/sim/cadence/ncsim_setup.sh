...
mkdir -p ./libraries/altera_xcvr_reset_control_170/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_xcvr_reset_control_170/sim/altera_xcvr_functions.sv"     -work altera_xcvr_reset_control_170 -cdslib ./cds_libs/altera_xcvr_reset_control_170.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_xcvr_reset_control_170/sim/alt_xcvr_resync.sv"           -work altera_xcvr_reset_control_170 -cdslib ./cds_libs/altera_xcvr_reset_control_170.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_xcvr_reset_control_170/sim/altera_xcvr_reset_control.sv" -work altera_xcvr_reset_control_170 -cdslib ./cds_libs/altera_xcvr_reset_control_170.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_xcvr_reset_control_170/sim/alt_xcvr_reset_counter.sv"    -work altera_xcvr_reset_control_170 -cdslib ./cds_libs/altera_xcvr_reset_control_170.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/reset_control.v"                                                   -work reset_control                                                                         
fi
