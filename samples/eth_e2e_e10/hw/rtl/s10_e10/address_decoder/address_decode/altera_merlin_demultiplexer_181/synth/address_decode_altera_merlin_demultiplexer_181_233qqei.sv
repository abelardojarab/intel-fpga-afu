...
//   output_name:         address_decode_altera_merlin_demultiplexer_181_233qqei
//   ST_DATA_W:           128
//   ST_CHANNEL_W:        60
//   NUM_OUTPUTS:         60
//   VALID_WIDTH:         60
...
module address_decode_altera_merlin_demultiplexer_181_233qqei
(
    // -------------------
    // Sink
    // -------------------
    ...
    output reg [128-1    : 0] src30_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src31_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src32_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src33_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src34_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src35_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src36_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src37_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src38_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src39_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src40_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src41_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src42_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src43_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src44_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src45_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src46_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src47_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src48_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src49_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src50_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src51_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src52_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src53_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src54_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src55_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src56_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src57_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src58_data, // ST_DATA_W=128
    ...
    output reg [128-1    : 0] src59_data, // ST_DATA_W=128
