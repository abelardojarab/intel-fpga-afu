...
module address_decode_altera_merlin_traffic_limiter_181_reppfiq
#(
   parameter
      PKT_TRANS_POSTED           = 1,
      PKT_DEST_ID_H              = 0,
   ...
   generate
      if (REORDER) begin: fifo_dest_id_write_read_control_reorder_on
         ...
         for (j = 0;j < MAX_DEST_ID; j = j+1) begin : trans_sequence_per_fifo
            ...
            address_decode_altera_merlin_traffic_limiter_181_ohcvrpq #(
                  .SYMBOLS_PER_BEAT   (1),
            ...
            //alt_hiconnect_sc_fifo # (
              address_decode_altera_merlin_traffic_limiter_181_avmww2q # (
                .IMPL                  ("reg"),
                .SYMBOLS_PER_BEAT      (1),   
