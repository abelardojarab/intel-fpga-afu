...
append ELAB_OPTIONS [subst [altera_eth_10g_mac::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [altera_eth_10g_mac::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
set design_libraries [dict merge $design_libraries [altera_eth_10g_mac::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [altera_eth_10g_mac::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [altera_eth_10g_mac::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
