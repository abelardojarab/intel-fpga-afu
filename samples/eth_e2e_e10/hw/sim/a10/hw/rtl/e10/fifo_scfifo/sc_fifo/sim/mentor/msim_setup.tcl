...
# ----------------------------------------
# If sc_fifo.sc_fifo is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.0 290 linux 2017.11.29.16:13:33
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "sc_fifo.sc_fifo"
}
...
alias com {
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/sc_fifo.v"                                                -work sc_fifo                  
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_avalon_sc_fifo_170 -L sc_fifo -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_avalon_sc_fifo_170 -L sc_fifo -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
