...
#-------------------------------------------------------------------------------
set all_dc_fifo [get_entity_instances dc_fifo_0_altera_avalon_dc_fifo_181_vevbyjq]
...
set mem_regs [get_registers -nowarn *|dc_fifo_0_altera_avalon_dc_fifo_181_vevbyjq:*|mem*];
if {![llength [query_collection -report -all $mem_regs]] > 0} {
    set mem_regs [get_registers -nowarn dc_fifo_0_altera_avalon_dc_fifo_181_vevbyjq:*|mem*];
}

set internal_out_payload_regs [get_registers -nowarn *|dc_fifo_0_altera_avalon_dc_fifo_181_vevbyjq:*|internal_out_payload*];
