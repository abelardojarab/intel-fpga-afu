	sc_fifo_rx_sc_fifo #(
		...
		.almost_full_data  (_connected_to_almost_full_data_),  //  output,   width = 1,  almost_full.data
		.almost_empty_data (_connected_to_almost_empty_data_), //  output,   width = 1, almost_empty.data
		...
		.in_error          (_connected_to_in_error_),          //   input,   width = 6,             .error
		...
		.out_error         (_connected_to_out_error_)          //  output,   width = 6,             .error
	);
