source [file join [file dirname [info script]] ./../../../ip/sc_fifo/sc_fifo_rx_sc_fifo/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/sc_fifo/sc_fifo_tx_sc_fifo/sim/common/xcelium_files.tcl]
...
namespace eval sc_fifo {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    lappend design_files "xmvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"$QSYS_SIMDIR/sc_fifo.v\"  -work sc_fifo"
    return $design_files
  }
