	reset_control u0 (
		...
		.tx_analogreset_stat  (_connected_to_tx_analogreset_stat_),  //   input,  width = 1,  tx_analogreset_stat.tx_analogreset_stat
		.tx_digitalreset_stat (_connected_to_tx_digitalreset_stat_), //   input,  width = 1, tx_digitalreset_stat.tx_digitalreset_stat
