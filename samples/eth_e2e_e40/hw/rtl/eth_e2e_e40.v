...
eth_traff_ctrl #(.INST_ID(0))
inst_eth_traff_ctrl_0
(
    .cfg_clk    (hssi.f2a_prmgmt_ctrl_clk) ,// i[0]
    .cfg_reset  (hssi.f2a_prmgmt_arst) ,// i[0]
    .cfg_read   (eth_traff_rd       ) ,// i[0]
    .cfg_write  (eth_traff_wr       ) ,// i[0]
    .cfg_address(eth_traff_addr     ) ,// i[15:0]
    .cfg_wrdata (eth_traff_wdata    ) ,// i[31:0]
    .cfg_rddata (eth_traff_rdata_0  ) ,// o[31:0]
    .tx_clk     (hssi.f2a_tx_clk    ) ,// i[0]
    .tx_reset   (tx_reset_0         ) ,// i[0]
    .tx_ready   (l4_tx_ready_0      ) ,// i[0]
    .tx_data    (l4_tx_data_0       ) ,// o[255:0]
    .tx_valid   (l4_tx_valid_0      ) ,// o[0]
    .tx_sop     (l4_tx_sop_0        ) ,// o[0]
    .tx_eop     (l4_tx_eop_0        ) ,// o[0]
    .tx_empty   (l4_tx_empty_0      ) ,// o[4:0]
    .tx_error   (l4_tx_error_0      ) ,// o[0]
    .rx_clk     (hssi.f2a_rx_clk_ln0) ,// i[0]
    .rx_reset   (rx_reset_0         ) ,// i[0]
    .rx_data    (l4_rx_data_0       ) ,// i[255:0]
    .rx_valid   (l4_rx_valid_0      ) ,// i[0]
    .rx_sop     (l4_rx_sop_0        ) ,// i[0]
    .rx_eop     (l4_rx_eop_0        ) ,// i[0]
    .rx_empty   (l4_rx_empty_0      ) ,// i[4:0]
    .rx_error   (l4_rx_error_0      ) ,// i[0]
    .rx_ready   (l4_rx_ready_0      )  // o[0]
);
