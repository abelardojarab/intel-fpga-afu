...
mkdir -p ./libraries/write_dc_fifo/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_170/sim/write_dc_fifo_fifo_170_bhnb7cq.v" -work fifo_170      -cdslib ./cds_libs/fifo_170.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/write_dc_fifo.v"                                  -work write_dc_fifo                                    
fi
