...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_170/sim/req_C1TxRAM2PORT_ram_2port_170_hecum7i.v" -work ram_2port_170    -cdslib ./cds_libs/ram_2port_170.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/req_C1TxRAM2PORT.v"                                            -work req_C1TxRAM2PORT                                         
fi
